<template>
	...
	<div class="my-1">
		<div class="flex items-center">
			...
			<input v-model="name" v-bind:id="`item-${item.id}-input`" type="text" class="bg-gray-50 w-full border-b border-transparent focus:outline-none focus:border-blue-500" v-on:keyup.enter="$emit('create-item', item.id)" />
		</div>
